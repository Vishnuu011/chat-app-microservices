...
const styles: Record<string, React.CSSProperties> = {
  overlay: { position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', backdropFilter: 'blur(8px)', padding: 16 },
  card: {
  ...
  name: { fontSize: 22, fontWeight: 700, color: 'var(--text-primary)', textAlign: 'center' as const },
  subtitle: { color: 'var(--text-secondary)', fontSize: 14, marginBottom: 8, textAlign: 'center' as const },
  actions: { display: 'flex', gap: 32 },
  rejectBtn: { width: 60, height: 60, borderRadius: '50%', background: '#ef4444', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 16px rgba(239,68,68,0.4)', transition: 'transform 0.15s', flexShrink: 0 },
  acceptBtn: { width: 60, height: 60, borderRadius: '50%', background: 'var(--accent)', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 16px rgba(0,168,132,0.4)', transition: 'transform 0.15s', flexShrink: 0 },
  labels: { display: 'flex', gap: 48, color: 'var(--text-secondary)', fontSize: 12 },
};
